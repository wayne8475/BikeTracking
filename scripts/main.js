...
navbar3.addEventListener("click", function() {
    if(mode == 1)
    {
        ...
        date_filter = "?date_filter=" + d.getFullYear() + '-' + (month <10 ? '0' : '') + month + '-' + (d.getDate()<10 ? '0' : '') + (d.getDate()-1)+' '+ "00:00:00" + '+-+' + d.getFullYear() + '-' + (month<10 ? '0' : '') + month + '-' + (d.getDate()<10 ? '0' : '') + d.getDate()+' '+"23:59:59";
